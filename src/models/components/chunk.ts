...
/** @internal */
export const Chunk$inboundSchema: z.ZodType<Chunk, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Chunk$outboundSchema: z.ZodType<Chunk$Outbound, z.ZodTypeDef, Chunk> = z.object({
    timestamp: z.array(z.any()),
    text: z.string(),
});
