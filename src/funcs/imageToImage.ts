...
export async function imageToImage(
    ...
    Result<
        operations.ImageToImageResponse,
        | errors.HTTPError
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => components.BodyImageToImageImageToImagePost$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ImageToImageResponse$inboundSchema, { key: "ImageResponse" }),
